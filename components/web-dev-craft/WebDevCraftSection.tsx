...
export function WebDevCraftSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="craft"
      className="hidden scroll-mt-28 bg-black py-16 text-cream md:block md:py-32"
    ...
    >
      <div className="mx-auto max-w-5xl px-6 lg:max-w-7xl xl:px-8">
        ...
        >
          <span className="text-cream">Web development craft</span> from
          strategy to <span className="text-cream">shippable UI</span>
        </h2>
